...
from config import WHISPER_API_KEY, OPENAI_API_KEY, EMAIL_ADDRESS, EMAIL_PASSWORD, MONGODB_URI
...
# MongoDB setup
MONGODB_URI = os.environ["MONGODB_URI"]  # Replace this with your MongoDB connection string
